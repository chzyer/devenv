...
(let (
  ...
  (custom-theme-set-faces
   ...
   `(cursor                                    ((t (:background ,darktooth-bright_red ))))
...
;;   `(font-lock-type-face                       ((t (:foreground ,darktooth-neutral_yellow ))))
