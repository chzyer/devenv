...
hi Cursor                       ctermfg=NONE ctermbg=248  cterm=NONE         guifg=#1a1a1a guibg=#c2a96b gui=NONE
...
hi CursorColumn                 ctermfg=NONE ctermbg=235  cterm=NONE         guifg=NONE    guibg=#1a1a1a gui=NONE
hi ColorColumn                  ctermfg=NONE ctermbg=235  cterm=NONE         guifg=NONE    guibg=#1a1a1a gui=NONE
hi LineNr                       ctermfg=245  ctermbg=235  cterm=NONE         guifg=#868686 guibg=#1a1a1a gui=NONE
hi VertSplit                    ctermfg=240  ctermbg=240  cterm=NONE         guifg=#232323 guibg=#232323 gui=NONE
hi MatchParen                   ctermfg=179  ctermbg=NONE cterm=NONE         guifg=#cda869 guibg=NONE    gui=NONE
hi StatusLine                   ctermfg=231  ctermbg=240  cterm=bold         guifg=#feffd8 guibg=#232323 gui=bold
hi StatusLineNC                 ctermfg=231  ctermbg=240  cterm=NONE         guifg=#feffd8 guibg=#232323 gui=NONE
...
hi Search                       ctermfg=NONE ctermbg=59   cterm=NONE         guifg=#1a1a1a guibg=#d4a64b gui=NONE
hi Directory                    ctermfg=167  ctermbg=NONE cterm=NONE         guifg=#cf6a4c guibg=NONE    gui=NONE
hi Folded                       ctermfg=59   ctermbg=233  cterm=NONE         guifg=#5f5a60 guibg=#1a1a1a gui=NONE

hi Normal                       ctermfg=231  ctermbg=233  cterm=NONE         guifg=#feffd8 guibg=#1a1a1a gui=NONE
...
hi NonText                      ctermfg=239  ctermbg=234  cterm=NONE         guifg=#4f4f4f guibg=#1a1a1a gui=NONE
...
hi Special                      ctermfg=231  ctermbg=NONE cterm=NONE         guifg=#feffd8 guibg=NONE    gui=NONE
...
hi Title                        ctermfg=231  ctermbg=NONE cterm=bold         guifg=#feffd8 guibg=NONE    gui=bold
...
" vimdiff
hi diffAdd                      ctermfg=231  ctermbg=107  cterm=NONE         guifg=#feffd8 guibg=#8f9d6a gui=NONE
hi diffDelete                   ctermfg=231  ctermbg=167  cterm=NONE         guifg=#feffd8 guibg=#cf6a4c gui=NONE
hi diffChange                   ctermfg=231  ctermbg=103  cterm=NONE         guifg=#feffd8 guibg=#7587a6 gui=NONE
hi diffText                     ctermfg=231  ctermbg=139  cterm=NONE         guifg=#feffd8 guibg=#af87af gui=NONE
